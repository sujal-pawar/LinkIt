...
export interface ScrollExpandProps {
  src?: string;
  /** 'custom' renders `media` (any React node) instead of an <img>/<video>. */
...
const ScrollExpand: React.FC<ScrollExpandProps> = ({
  ...
  const media =
    mediaType === 'custom' ? (
      // Same ref + transform target as <img>/<video>, so the zoom-out effect
      // works identically for arbitrary markup.
      <div
        ref={mediaRef as unknown as React.Ref<HTMLDivElement>}
